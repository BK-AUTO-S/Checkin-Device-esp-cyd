...
### If in platformio.ini we have lib_deps like this then we install successfully
![alt text](image.png)

3. Configure User_Setup.h in TFT_eSPI

- In ../.pio/TFT_eSPI: You will see a header file called __User_Setup.h__

- Please use this code below for a stable process
...
- In ../.pio/lvgl, you will see a file called __lv_conf_template.h__ , please move this file to __src folder__ and change it's name to __lv_conf.h__

- Then make sure the contents look like this
